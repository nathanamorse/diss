/*                                                                              
/*            SPSS DATA DEFINITION STATEMENTS FOR ICPSR 0002                    
/*                Candidate Name and Constituency Totals                        
/*             of Elections in the United States, 1788-1990                     
/*                                                                              
/*                        FIFTH ICPSR EDITION                                   
/*                            March, 1995                                       
/*                                                                              
/*   Four SPSS setup sections are provided in this file for the LRECL           
...
/*                                                                              
/*   VARIABLE LABELS assigns identifying labels for most of the variables in    
/*   the data file.                                                             
/*                                                                              
/*   MISSING VALUE COMMANDS declares the values of variables which will be      
/*   defined as user-missing.  Note:  These are designated as comments.         
/*                                                                              
/*   VALUE LABELS assigns value labels to most of the variables which           
/*   have value descriptions in the codebook. Some value labels were            
/*   abbreviated and truncated in order to meet the SPSS limitation on the      
...
/*   file beginning with 1968 elections for V5.  If V5 does equal 7 then in     
/*   V6, accompanying the office code of "7", will be a state office code.      
/*                                                                              
...
/*                                                                              
/*  ************************************************************************    
DATA LIST FILE='da0002.5ed' NOTABLE RECORDS=1/                                  
  V1  1-2                                                                       
  V2  3 (A)                                                                     
  V3  4-6                                                                       
  V4  7-8                                                                       
...
VARIABLE LABELS                                                                 
  ...
  V4 "ICPSR STATE CODE"                                                         
  V5 "OFFICE CODE"                                                              
  V6 "CONGRESSIONAL DIST NO"                                                    
  V7 "ASTERISK ONLY"                                                            
  V8 "BLANK FIELD"                                                              
  V9 "CANDIDATE'S VOTE TOTAL"                                                   
  V10 "MONTH OF ELECTION"                                                       
  V11 "ELECTION TYPE CODE"                                                      
  V12 "ICPSR PARTY CODE"                                                        
  V13 "CANDIDATE'S NAME"                                                        
  .                                                                             
/* MISSING VALUES                                                               
/*   V1 (99)                                                                    
/*   V3 (000)                                                                   
...
/*  elections.  If variable 5, is coded "7", variable 6 will be                 
/*  one of the following codes:                                                 
/*                  001 "Sec. of State "                                        
/*                  002 "Att. General "                                         
/*                  003 "State Auditor "                                        
/*                  004 "State Treas. "                                         
/*                  005 "Auditor Pub. Accounts "                                
/*                  006 "Pub. Service Comm."                                    
/*                  007 "Comptroller "                                          
/*                  008 "Lt. Governor "                                         
/*                  009 "Comm. of Labor "                                       
/*                  010 "Tax Commissioner "                                     
/*                  011 "Corporation Comm."                                     
                    999 "MISSING DATA"/                                         
             V9     -000009  "MISSING DATA"/                                    
             V10    01 "January "                                               
                    02 "February "                                              
                    03 "March "                                                 
                    04 "April "                                                 
