...
```{=html}
<style>
  .quarto-title {margin-bottom: 2em;}
  #title-block-header {margin-block-end: 2em !important;}
  h2 {border-bottom: 0;}
  ...
  h6, #title-block-header.quarto-title-block.default .quarto-title-meta-heading, #title-block-header.quarto-title-block.default .description .abstract-title, #title-block-header.quarto-title-block.default .abstract .abstract-title {font-family: var(--bs-body-font-family); color: #444; font-weight: bold; opacity: .4; font-size: .8em; margin-bottom: 0.1em; text-transform: uppercase; letter-spacing: 0;}
  details {margin-bottom: .2em;}
  summary {font-weight: normal; letter-spacing: 0; text-transform: none; font-size: .9em; line-height: 1.2em;}
  summary::marker {font-size: .7em; transition: .1s linear; padding-right: .4em;}
  details .cell-code {margin: .5em 0 .5em .7em;}
  .draft-warning {display: none;}
  .version p {margin-bottom: 10px;}
  .version li p {margin-bottom: 0;}
  .version li {margin-bottom: 0 !important;}
</style>
```
### Abstract {.mt-4}
...
::: {.callout-note .mt-0 .mb-3 collapse="true"}
## Copyright
...
::: version
**Current: Version 1.11** (March 15, 2024)

-   Made minor improvements to [Chapter @sec-entrenchment]
...
::: version
[**Version 1.10**](https://nmorse.com/dissertation/v1.10/) (March 11, 2024)

-   Added "Advancements made by this work" section to [Chapter @sec-intro]

-   Rewrote most of [Chapter @sec-conclusion]

-   Restructured [Chapter @sec-entrenchment]
...
::: version
[**Version 1.00**](https://nmorse.com/dissertation/v1/) (February 16, 2024)
...
<style>
  ...
  .figure-section h2 {margin: 0; padding-bottom: 0;}
  .figure-section h4 {margin: 0.2em 0 1em 0; font-size: 1.5em; letter-spacing: -.3px;}
  ...
  h1.hidden-header, h2.hidden-header {display: none;}
  ...
  /* Footnotes */
  #notes {padding-top: 70px;}
  #footnotes hr {display: none;}
  
</style>
```
# Visual summary {.hidden-header}

::: {.figure-section .column-screen .pt-0 style="background: #fafafa"}
::: {.shadow-top .page-full}
:::

::: {.column-body style="padding-top: 100px"}
###### Visual summary

## A Bird's-Eye View of American Politics {style="margin-top: 10px;"}
...
## 1. Party sorting in the twentieth century {.hidden-header}

::: {.figure-section .column-screen}
### 1. Party sorting in the twentieth century {.unlisted .flex-fill}

Over the course of the twentieth century, the South went from being the most economically progressive faction in Congress to being the most economically conservative. By 1900, Southern states had pioneered early anti-trust regulations that [protected farmers](https://www.jstor.org/stable/23515038 "<div class='ref'><p>Link, Arthur S. 1946. “<b>The Progressive Movement in the South, 1870-1914</b>.” <i>The North Carolina Historical Review</i> 23(2): 172–95.</p></div>"){target="_blank" data-bs-toggle="tooltip" data-bs-html="true"} from Northern corporations.[^index-1] The region then [supported most of the New Deal](http://www.jstor.org/stable/41881663 "<div class='ref'><p>DeJanes, R. Benneson. 1985. “<b>The Ex-Post Facto Effect: Southern Support for the New Deal</b>.” <i>International Social Science Review</i> 60(4): 153–59.</p></div>"){target="_blank" data-bs-toggle="tooltip" data-bs-html="true"}, which brought [much needed economic relief](http://www.jstor.org/stable/j.ctt130j2h9.8 "<div class='ref'><p>Biles, Roger. 1994. “<b>Relief and employment</b>.” In <i>The South and the New Deal</i>, University Press of Kentucky, 58–82.</p></div>"){target="_blank" data-bs-toggle="tooltip" data-bs-html="true"} to whites while carefully [excluding people of color](https://www.epi.org/publication/the-color-of-law-a-forgotten-history-of-how-our-government-segregated-america/ "<div class='ref'><p>Rothstein, Richard. 2017. <b><i>The color of law: A forgotten history of how our government segregated America</i></b>. Liveright Publishing.</p></div>"){target="_blank" data-bs-toggle="tooltip" data-bs-html="true"}.[^index-2] As explicit racial discrimination was slowly struck down through laws and court decisions, Southerners lost interest in these programs and became [drawn to the conservatism](https://doi.org/10.1093/oso/9780190265960.001.0001 "<div class='ref'><p>Maxwell, Angie, and Todd Shields. 2019. <b><i>The Long Southern Strategy: How Chasing White Voters in the South Changed American Politics</i></b>. Oxford University Press.</p></div>"){target="_blank" data-bs-toggle="tooltip" data-bs-html="true"} on the other side of the aisle.[^index-3]

::: {#fig-party-sorting .fig-img}
::: {.column-body-outset style="text-align: center;"}
```{=html}
...
[^index-1]: For example, Southern states led the nation in regulating the railroad industry to break up monopolies in the 1880s and 90s, which laid the groundwork for federal anti-trust regulations [@link1946].

[^index-2]: Southerners were usually against labor regulations and union protections, but they sided with Democrats on most other economic issues in the early twentieth century [@farhang2005]. See also: @dejanes1985, @biles1994, and @rothstein2017.

[^index-3]: Southerners started shifting into the Republican Party not because of its policy positions but because the party began using racist dog-whistles and Southern-style rhetoric to attract Southerners. This became known as the Southern Strategy. As @maxwell2019 write: "Republicans had to mirror southern white culture by emphasizing an 'us vs. them' outlook, preaching absolutes, accusing the media of bias, prioritizing identity over the economy, depicting one's way of life as under attack, encouraging defensiveness toward social changes, and championing a politics of vengeance."

## 2. Asymmetric polarization {.hidden-header}

::: {.figure-section .column-screen}
### 2. Asymmetric polarization {.unlisted .flex-fill}

As Southerners switched sides, the Republican Party grew large enough to push some of the most [free-market economic agendas](https://doi.org/10.7312/columbia/9780231169882.003.0002 "<div class='ref'><p>Rossinow, Doug. 2015. “<b>The Agenda</b>.” In <i>The Reagan Era: A History of the 1980s</i>. Columbia University Press, 31–46.</p></div>"){target="_blank" data-bs-toggle="tooltip" data-bs-html="true"} on record, according to data extracted from [party platforms](https://manifestoproject.wzb.eu/tutorials/primer "<div class='ref'><p>Manifesto Project Team. 2018. “<b>A short primer on the Manifesto Project and its methodology</b>.” Manifesto Project Database.</p></div>"){target="_blank" data-bs-toggle="tooltip" data-bs-html="true"} around the world.[^index-4] By the 2000s, the party moderated its economic stances but started moving into an [authoritarian direction](https://doi.org/10.1111/j.1540-5907.2011.00514.x "<div class='ref'><p>Hetherington, Marc, and Elizabeth Suhay. 2011. “<b>Authoritarianism, Threat, and Americans’ Support for the War on Terror</b>.” <i>American Journal of Political Science</i> 55(3): 546–60.</p></div>"){target="_blank" data-bs-toggle="tooltip" data-bs-html="true"} on social issues.[^index-5] Today, most parties that share Republicans' views are either small [fringe movements](https://doi.org/10.1146/annurev-polisci-042814-012441 "<div class='ref'><p>Golder, Matt. 2016. “<b>Far Right Parties in Europe</b>.” <i>Annual Review of Political Science</i> 19(1): 477–97.</p></div>"){target="_blank" data-bs-toggle="tooltip" data-bs-html="true"} or part of [autocratic regimes](https://doi.org/10.5129/001041518822704872 "<div class='ref'><p>Fish, M. Steven. 2018. “<b>What Has Russia Become?</b>” <i>Comparative Politics</i> 50(3): 327–46.</p></div>"){target="_blank" data-bs-toggle="tooltip" data-bs-html="true"}.[^index-6] This creates a situation known as [*asymmetric polarization*](http://dx.doi.org/10.1017/CBO9781316091906.003 "<div class='ref'><p>Hacker, Jacob S., and Paul Pierson. 2015. “<b>Confronting Asymmetric Polarization</b>.” In <i>Solutions to Political Polarization in America</i>, Cambridge University Press, 59–70.</p></div>"){target="_blank" data-bs-toggle="tooltip" data-bs-html="true"}, where one side has moved farther to the extremes than the other.[^index-7] The Democratic Party could easily have become the more extreme party if it had the Republican Party's electoral advantages.[^index-8]
...
## 3. Ideology and inequality {.hidden-header}

::: {.figure-section .column-screen}
### 3. Ideology and Inequality {.unlisted .flex-fill}

Soon after the parties began [drifting apart](https://press.uchicago.edu/ucp/books/book/chicago/P/bo8212972.html "<div class='ref'><p>Levendusky, Matthew. 2009. <b><i>The Partisan Sort: How Liberals Became Democrats and Conservatives Became Republicans</i></b>. University of Chicago Press.</p></div>"){target="_blank" data-bs-toggle="tooltip" data-bs-html="true"} on economic issues, the divide between the rich and poor [started growing](https://mitpress.mit.edu/9780262633611/ "<div class='ref'><p>McCarty, Nolan, Keith T. Poole, and Howard Rosenthal. 2006. <b><i>Polarized America: The Dance of Ideology and Unequal Riches</i></b>. MIT Press.</p></div>"){target="_blank" data-bs-toggle="tooltip" data-bs-html="true"}.[^index-9] The United States is now one of the most [polarized](https://doi.org/10.1162/rest_a_01160 "<div class='ref'><p>Boxell, Levi, Matthew Gentzkow, and Jesse M. Shapiro. 2022. “<b>Cross-Country Trends in Affective Polarization</b>.” <i>The Review of Economics and Statistics</i>: 1–60.</p></div>"){target="_blank" data-bs-toggle="tooltip" data-bs-html="true"} and [unequal](https://data.oecd.org/inequality/income-inequality.htm "<div class='ref'><p>OECD Data. 2024. “<b>Income inequality (indicator)</b>.” Organisation for Economic Co-operation and Development.</p></div>"){target="_blank" data-bs-toggle="tooltip" data-bs-html="true"} democracies in the world.[^index-10] Economic inequality [naturally deepens](https://www.hup.harvard.edu/catalog.php?isbn=9780674430006 "<div class='ref'><p>Piketty, Thomas. 2014. <b><i>Capital in the Twenty-First Century</i></b>. Harvard University Press.</p></div>"){target="_blank" data-bs-toggle="tooltip" data-bs-html="true"} over time in capitalist economies without routine maintenance to tax codes, labor regulations, and social programs, which becomes [especially difficult](https://www.jstor.org/stable/10.7864/j.ctt18z4ggp.6 "<div class='ref'><p>Barber, Michael J., and Nolan McCarty. 2015. “<b>Causes and Consequences of Polarization</b>.” In <i>Solutions to Political Polarization in America</i>, ed. Nathaniel Persily. Cambridge University Press, 15–58.</p></div>"){target="_blank" data-bs-toggle="tooltip" data-bs-html="true"} as parties polarize.[^index-11] These policies tended to fail in the Senate more than the House because of the Senate's [filibuster](https://doi.org/10.1017/S0022381613001321 "<div class='ref'><p>Enns, Peter K., Nathan J. Kelly, Jana Morgan, Thomas Volscho, and Christopher Witko. 2014. “<b>Conditional Status Quo Bias and Top Income Shares: How U.S. Political Institutions Have Benefited the Rich</b>.” <i>The Journal of Politics</i> 76(2): 289–303.</p></div>"){target="_blank" data-bs-toggle="tooltip" data-bs-html="true"} and [inequitable representation](https://press.uchicago.edu/ucp/books/book/chicago/S/bo3636044.html "<div class='ref'><p>Lee, Frances E, and Bruce I Oppenheimer. 1999. <b><i>Sizing up the Senate: The Unequal Consequences of Equal Representation</i></b>. University of Chicago Press.</p></div>"){target="_blank" data-bs-toggle="tooltip" data-bs-html="true"}.[^index-12] Partisanship in the Senate is one of the [strongest predictors](https://nmorse.com/thesis/ "<div class='ref'><p>Morse, Nathan. 2021. “<b>Untangling Ideology and Inequality in the United States: How Polarization Deepens Economic Inequality</b>.” Master’s thesis. Pennsylvania State University.</p></div>"){target="_blank" data-bs-toggle="tooltip" data-bs-html="true"} of income inequality; they follow a very similar path but a decade apart.[^index-13]

::: {#fig-ideology-inequality .column-body}
```{r}
fig2
```
...
[^index-9]: See @levendusky2013 and @hetherington2009 for details on the roots of polarization in the twentieth century and @mpr for analyses of the feedback loop between polarization and economic inequality.

[^index-10]: A *democracy* is a country that is run by the people either directly or indirectly through elected representatives. For a country to be considered a democracy, it must have generally free elections, universal adult suffrage, and equality before the law. This is closer to James Madison's definition of a *republic* in *Federalist* 10 [-@fed10], and his definition of *democracy* is closer to what today is called a *direct democracy*. Some Americans still use the older definition, but most of the world uses the more modern one.
...
## 4. Democratic breakdown {.hidden-header}

::: {.figure-section .column-screen}
### 4. Democratic breakdown {.unlisted .flex-fill}

The rising polarization, inequality, and authoritarianism reached a breaking point in 2016, when American democracy began deteriorating more quickly than at any point in its history.[^index-14] While political scientists have ideas on how to [turn this around](https://medium.com/@scholars-redistricting-reform/open-letter-to-congress-to-end-single-member-congressional-districts-and-adopt-proportional-97ad1cf6aa2e "<div class='ref'><p>Scholars for Redistricting Reform. 2022. “<b>Letter to Congress on Ending Single Member Congressional Districts and Adopting Proportional Representation Scholars for Redistricting Reform</b>.” <i>Medium</i>.</p></div>"){target="_blank" data-bs-toggle="tooltip" data-bs-html="true"}, getting these reforms passed is a puzzle that has yet to be solved.[^index-15] The US has one of the most entrenched political systems in the world; policy changes and constitutional amendments are [harder to pass](https://doi.org/10.1093/icon/mov041 "<div class='ref'><p>Ginsburg, T., and J. Melton. 2015. “<b>Does the Constitutional Amendment Rule Matter at All?: Amendment Cultures and the Challenges of Measuring Amendment Difficulty</b>.” <i>International Journal of Constitutional Law</i> 13(3): 686–713.</p></div>"){target="_blank" data-bs-toggle="tooltip" data-bs-html="true"} and [more elite-run](https://doi.org/10.1007/978-3-319-57798-2_9 "<div class='ref'><p>Qvortrup, Matt. 2018. “<b>Two Hundred Years of Referendums</b>.” In <i>Referendums Around the World</i>, Palgrave Macmillan, 263–72.</p></div>"){target="_blank" data-bs-toggle="tooltip" data-bs-html="true"} than in other countries.[^index-16] [Many democracies](https://doi.org/10.5539/jpl.v7n1p12 "<div class='ref'><p>Anckar, Dag. 2014. “<b>Constitutional Referendums in the Countries of the World</b>.” <i>Journal of Politics and Law</i> 7(1).</p></div>"){target="_blank" data-bs-toggle="tooltip" data-bs-html="true"} and just over [half of the US states](https://ballotpedia.org/States_with_initiative_or_referendum "<div class='ref'><p>Ballotpedia. 2023. “States with Initiative or Referendum.” In <i>Encyclopedia of American Politics</i>.</p></div>"){target="_blank" data-bs-toggle="tooltip" data-bs-html="true"} involve the public when writing and amending their constitutions, which [prevents corruption](https://doi.org/10.1017/S0003055415000222 "<div class='ref'><p>Eisenstadt, Todd A., A. Carl LeVan, and Tofigh Maboudi. 2015. “<b>When Talk Trumps Text: The Democratizing Effects of Deliberation During Constitution-Making, 1974-2011</b>.” <i>American Political Science Review</i> 109(3): 592–612.</p></div>"){target="_blank" data-bs-toggle="tooltip" data-bs-html="true"}.[^index-17]
...
[^index-17]: Around half of the countries in the world use public referendums at some level for amendments, and most of the ones that do are generally democratic [@anckar2014]. A study of 62 countries that adopted a new constitution between 1974 and 2011 found that more public participation in the drafting process led to significantly higher levels of democracy in the following years [@eisenstadt2015].

## 5. Constitutional design {.hidden-header}

::: {.figure-section .column-screen}
### 5. Constitutional design {.unlisted .flex-fill}

The US Constitution was one of the first of its kind, and [nearly 1,000 national constitutions](https://comparativeconstitutionsproject.org/download-data/ "<div class='ref'><p>Elkins, Zachary, Tom Ginsburg, and James Melton. 2005. “<b>Characteristics of National Constitutions [v.2.0]</b>.” Comparative Constitutions Project.</p></div>"){target="_blank" data-bs-toggle="tooltip" data-bs-html="true"} have been adopted since it was written.[^index-18] Two general constitutional models have emerged: *majoritarian* and *consensus* democracies.[^index-19] [This table](#dem-models){data-bs-toggle="collapse"} lays out some of the main characteristics of each. The US is majoritarian, whereas [most modern democracies](https://www.electoral-reform.org.uk/how-many-countries-around-the-world-use-proportional-representation/ "<div class='ref'><p>Ridley-Castle, Thea. 2023. “<b>How many countries around the world use proportional representation?</b>” Electoral Reform Society.</p></div>"){target="_blank" data-bs-toggle="tooltip" data-bs-html="true"} are more consensus-based.[^index-20] The majoritarian model gives rise to [two-party systems](https://doi.org/10.2307/1962968 "<div class='ref'><p>Riker, William H. 1982. “<b>The Two-Party System and Duverger’s Law: An Essay on the History of Political Science</b>.” <i>American Political Science Review</i> 76(4): 753–66.</p></div>"){target="_blank" data-bs-toggle="tooltip" data-bs-html="true"} and often struggles in [diverse societies](https://doi.org/10.1080/02589347708704717 "<div class='ref'><p>Lijphart, Arend. 1977. “<b>Majority Rule Versus Democracy in Deeply Divided Societies</b>.” <i>Politikon</i> 4(2): 113–26.</p></div>"){target="_blank" data-bs-toggle="tooltip" data-bs-html="true"}.[^index-21] Countries nowadays tend to [avoid modeling](https://ssrn.com/abstract=3523330 "<div class='ref'><p>Klug, Heinz. 2000. “<b>Model and Anti-Model: The United States Constitution and the Rise of World Constitutionalism</b>.” <i>Wisconsin Law Review</i> 2000.</p></div>"){target="_blank" data-bs-toggle="tooltip" data-bs-html="true"} their constitutions on the American system due its [poor track record](https://muse.jhu.edu/article/225694/pdf "<div class='ref'><p>Linz, Juan J. 1990. “<b>The Perils of Presidentialism</b>.” <i>Journal of Democracy</i> 1(1): 51–69.</p></div>"){target="_blank" data-bs-toggle="tooltip" data-bs-html="true"} outside of the US (and arguably [within the US](https://www.nyulawreview.org/issues/volume-87-number-3/the-declining-influence-of-the-united-states-constitution/ "<div class='ref'><p>Law, David S, and Mila Versteeg. 2012. “<b>The Declining Influence of the United States Constitution</b>.” <i>NYU Law Review</i> 87: 762.</p></div>"){target="_blank" data-bs-toggle="tooltip" data-bs-html="true"} now too).[^index-22]
...
## 6. Proportional representation {.hidden-header}

::: {.figure-section .column-screen .border-bottom}
### 6. Proportional representation {.unlisted .flex-fill}

Consensus democracies are built on [*proportional representation*](https://protectdemocracy.org/work/proportional-representation-explained/ "<div class='ref'><p>Protect Democracy. 2023. “<b>Proportional representation, explained</b>.”</p></div>"){target="_blank" data-bs-toggle="tooltip" data-bs-html="true"}, an electoral system that started gaining steam around a century after the US Constitution was written.[^index-23] These countries tend to have [more political parties](https://doi.org/10.2307/1962968 "<div class='ref'><p>Riker, William H. 1982. “<b>The Two-Party System and Duverger’s Law: An Essay on the History of Political Science</b>.” <i>American Political Science Review</i> 76(4): 753–66.</p></div>"){target="_blank" data-bs-toggle="tooltip" data-bs-html="true"}, [less polarization](https://doi.org/10.1080/13510347.2022.2117300 "<div class='ref'><p>Bernaerts, Kamil, Benjamin Blanckaert, and Didier Caluwaerts. 2022. “<b>Institutional Design and Polarization. Do Consensus Democracies Fare Better in Fighting Polarization Than Majoritarian Democracies?</b>” <i>Democratization</i> 30(2): 153–72.</p></div>"){target="_blank" data-bs-toggle="tooltip" data-bs-html="true"}, [less economic inequality](https://doi.org/10.1023/A:1006960528737 "<div class='ref'><p>Birchfield, Vicki, and Markus M.L. Crepaz. 1998. “<b>The Impact of Constitutional Structures and Collective and Competitive Veto Points on Income Inequality in Industrialized Democracies</b>.” <i>European Journal of Political Research</i> 34(2): 175–200.</p></div>"){target="_blank" data-bs-toggle="tooltip" data-bs-html="true"}, [better quality governance](https://www.jstor.org/stable/j.ctt32bg23 "<div class='ref'><p>Lijphart, Arend. 2017. <b><i>Patterns of Democracy</i></b>. Yale University Press.</p></div>"){target="_blank" data-bs-toggle="tooltip" data-bs-html="true"}, and [higher public satisfaction](https://doi.org/10.2307/2952259 "<div class='ref'><p>Anderson, Christopher J., and Christine A. Guillory. 1997. “<b>Political Institutions and Satisfaction with Democracy: A Cross-National Analysis of Consensus and Majoritarian Systems</b>.” <i>American Political Science Review</i> 91(1): 66–81.</p></div>"){target="_blank" data-bs-toggle="tooltip" data-bs-html="true"} with the political system.[^index-24] The US could [pass a law](https://protectdemocracy.org/work/proportional-representation-uniform-congressional-district-act/ "<div class='ref'><p>Tudor, Grant, and Beau Tremitiere. 2023. <b><i>Towards Proportional Representation for the U.S. House: Amending the Uniform Congressional District Act</i></b>. Protect Democracy and Unite America.</p></div>"){target="_blank" data-bs-toggle="tooltip" data-bs-html="true"} adopting proportional representation in the House,[^index-25] which would empower more parties and [force them to cooperate](https://doi.org/10.1111/j.1477-7053.2005.00143.x "<div class='ref'><p>Colomer, Josep M., and Gabriel L. Negretto. 2005. “<b>Can Presidentialism Work Like Parliamentarism?</b>” <i>Government and Opposition</i> 40(1): 60–89.</p></div>"){target="_blank" data-bs-toggle="tooltip" data-bs-html="true"} rather than just compete.[^index-26] The Senate and Electoral College are more [difficult to change](https://news.harvard.edu/gazette/story/2022/11/change-the-senate-vicki-c-jackson/ "<div class='ref'><p>Jackson, Vicki. 2022. “<b>Change the Senate: Disproportionate influence of smaller states creates ‘significant democratic deficit’</b>.” <i>The Harvard Gazette</i>.</p></div>"){target="_blank" data-bs-toggle="tooltip" data-bs-html="true"} and together hold far more power than the House, so shifting to a more consensus-based model of democracy in the long term would take constitutional reform.
...
// Replace "Summary" with "Front matter" in table of contents
document.addEventListener('DOMContentLoaded', (event) => {
  const targetElement = document.querySelector('#TOC > ul > li > a');
  if(targetElement) {
      targetElement.textContent = 'Front matter';
  } else {
